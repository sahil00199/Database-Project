...
/**
 * Servlet implementation class InstructorQuesOptions
 */
@WebServlet("/InstructorQuesOptions")
public class InstructorQuesOptions extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InstructorQuesOptions() {
        super();
