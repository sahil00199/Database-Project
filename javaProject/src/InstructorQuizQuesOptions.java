...
/**
 * Servlet implementation class InstructorQuizQuesOptions
 */
@WebServlet("/InstructorQuizQuesOptions")
public class InstructorQuizQuesOptions extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InstructorQuizQuesOptions() {
        super();
