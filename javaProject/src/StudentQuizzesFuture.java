...
/**
 * Servlet implementation class StudentQuizzesFuture
 */
@WebServlet("/StudentQuizzesFuture")
public class StudentQuizzesFuture extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StudentQuizzesFuture() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query1 =  //TODO: verify query
				"select qzid, qzname "
				+ "from quiz "
				+ "where secid = ? and cast(? as timestamp) <=  start "
				+ "order by start desc ;";
