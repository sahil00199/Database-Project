...
/**
 * Servlet implementation class StudentQuizzesOngoing
 */
@WebServlet("/StudentQuizzesOngoing")
public class StudentQuizzesOngoing extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StudentQuizzesOngoing() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query1 =  //TODO: verify query
				"select qzid, qzname "
				+ "from quiz "
				+ "where secid = ? and start <= cast(? as timestamp) and cast(? as timestamp) <= (start+duration) "
				+ "order by start desc ;";
