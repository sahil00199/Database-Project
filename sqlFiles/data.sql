...
insert into student values('i1', 'i1', 'i1@email.com', 'i1');
insert into student values('i2', 'i2', 'i2@email.com', 'i2');
insert into student values('i3', 'i3', 'i3@email.com', 'i3');
insert into student values('i4', 'i4', 'i4@email.com', 'i4');
insert into student values('i5', 'i5', 'i5@email.com', 'i5');
insert into student values('i6', 'i6', 'i6@email.com', 'i6');
insert into student values('i7', 'i7', 'i7@email.com', 'i7');
insert into student values('t1', 't1', 't1@email.com', 't1');
insert into student values('t2', 't2', 't2@email.com', 't2');
insert into student values('t3', 't3', 't3@email.com', 't3');
insert into student values('t4', 't4', 't4@email.com', 't4');
insert into student values('t5', 't5', 't5@email.com', 't5');
insert into student values('t6', 't6', 't6@email.com', 't6');
insert into student values('t7', 't7', 't7@email.com', 't7');
...
insert into instructor values('s1', 's1', 's1@email.com', 's1');
insert into instructor values('s2', 's2', 's2@email.com', 's2');
insert into instructor values('s3', 's3', 's3@email.com', 's3');
insert into instructor values('s4', 's4', 's4@email.com', 's4');
insert into instructor values('s5', 's5', 's5@email.com', 's5');
insert into instructor values('s6', 's6', 's6@email.com', 's6');
insert into instructor values('s7', 's7', 's7@email.com', 's7');
...
insert into ta values('s1', 's1', 's1@email.com', 's1');
insert into ta values('s2', 's2', 's2@email.com', 's2');
insert into ta values('s3', 's3', 's3@email.com', 's3');
insert into ta values('s4', 's4', 's4@email.com', 's4');
insert into ta values('s5', 's5', 's5@email.com', 's5');
insert into ta values('s6', 's6', 's6@email.com', 's6');
insert into ta values('s7', 's7', 's7@email.com', 's7');
insert into ta values('i1', 'i1', 'i1@email.com', 'i1');
insert into ta values('i2', 'i2', 'i2@email.com', 'i2');
insert into ta values('i3', 'i3', 'i3@email.com', 'i3');
insert into ta values('i4', 'i4', 'i4@email.com', 'i4');
insert into ta values('i5', 'i5', 'i5@email.com', 'i5');
insert into ta values('i6', 'i6', 'i6@email.com', 'i6');
insert into ta values('i7', 'i7', 'i7@email.com', 'i7');
